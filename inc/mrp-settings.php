...
function restpost_create_new_post() {
	...
	<form id="new_restpost_post" name="new_restpost_post" method="post" action="">
		<table class="restposts-shortcode-table">
	<tr><th>Title</th><th>Description</th><th>Website <span class="rp_tooltip"><span class="rp_tooltiptext">Enter the WordPress website url like: https://www.restposts.com</span><i class="fa fa-question-circle" aria-hidden="true"></i></span></th><th>#Posts <span class="rp_tooltip"><span class="rp_tooltiptext">How many posts would you like to display with this shortcode?</span><i class="fa fa-question-circle" aria-hidden="true"></i></span></th><th>#Columns <span class="rp_tooltip"><span class="rp_tooltiptext">How many columns would you like to display the posts in? (1, 2, 3 or 4 columns)</span><i class="fa fa-question-circle" aria-hidden="true"></i></span></th><th>Excerpt Limit <span class="rp_tooltip"><span class="rp_tooltiptext">Limit the number of words to be displayed from the excerpts.</span><i class="fa fa-question-circle" aria-hidden="true"></i></span></th><th>Title Size <span class="rp_tooltip"><span class="rp_tooltiptext">Enter a custom size(px) for displaying post titles.</span><i class="fa fa-question-circle" aria-hidden="true"></i></span></th><th colspan="2">Offset <span class="rp_tooltip"><span class="rp_tooltiptext">Enter a number here if you want to skip a few posts.</span><i class="fa fa-question-circle" aria-hidden="true"></i></span></th></tr>
